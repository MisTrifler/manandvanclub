      ...
      {isOpen && (
        <div className="lg:hidden absolute top-14 left-0 w-full bg-white border-b border-border shadow-xl p-6 flex flex-col gap-6 max-h-[80vh] overflow-y-auto">
          ...
          <div className="flex flex-col gap-3 pt-4 border-t border-border">
            ...
            <Link href="/#quote-form" className="btn-orange py-4 rounded-xl font-black uppercase tracking-widest text-xs text-center" onClick={() => setIsOpen(false)}>Start Request</Link>
          </div>
        </div>
      )}
    </header>
