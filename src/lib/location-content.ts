...
export function getLocationPageData(slug: string): LocationPageData | null {
  ...
  const baseData = {
    name: loc.name,
    title: `Man and Van ${loc.name} | From £34 | Verified Local Movers`,
    description: loc.region === 'Greater London'
      ...
      : `Man and van ${loc.name} from £34/hr. One verified mover quotes. Free to submit, no multiple companies. Call 0121 751 1269.`,
