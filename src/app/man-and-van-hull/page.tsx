...
export const metadata: Metadata = {
  ...
  description: "Man with a van in Hull from £19/hr. One verified mover reviews your details before you book. Rated 5.0/5 from 5 reviews. City centre, Anlaby, Cottingham, Hessle.",
  alternates: { canonical: `${baseUrl}/man-and-van-hull` },
  openGraph: {
    title: "Man and Van Hull From £19/hr | Free Quotes",
    description: "Man with a van in Hull from £19/hr. One verified mover reviews your details before you book. Rated 5.0/5 from 5 reviews.",
