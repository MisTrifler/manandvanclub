...
export const metadata: Metadata = {
  title: "Man and Van Hull | Verified Mover Quotes from £19",
  description: "Submit a free man and van request in Hull. One verified mover reviews your details before you book. From £19/hr. City centre, Anlaby, Cottingham, Hessle.",
  alternates: { canonical: `${baseUrl}/man-and-van-hull` },
  openGraph: {
    title: "Man and Van Hull | Verified Mover Quotes from £19",
    description: "Submit a free man and van request in Hull. One verified mover reviews your details before you book. From £19/hr.",
    url: `${baseUrl}/man-and-van-hull`,
    images: [{ url: `${baseUrl}/api/og?title=${encodeURIComponent("Man and Van Hull")}&subtitle=${encodeURIComponent("Verified Mover Quotes from £19")}`, width: 1200, height: 630, alt: "Man and Van Hull | Verified Mover Quotes from £19" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Man and Van Hull | Verified Mover Quotes from £19",
    description: "Submit a free man and van request in Hull. One verified mover reviews your details before you book. From £19/hr.",
    images: [`${baseUrl}/api/og?title=${encodeURIComponent("Man and Van Hull")}&subtitle=${encodeURIComponent("Verified Mover Quotes from £19")}`],
  },
};

const hullAreaCandidates = [
  { slug: "hull", name: "Hull", note: "City-centre flats, A63 corridor and student moves" },
  { slug: "york", name: "York", note: "Historic city moves, terraced streets and student relocations" },
  { slug: "leeds", name: "Leeds", note: "Major Yorkshire hub for cross-region moves" },
  { slug: "sheffield", name: "Sheffield", note: "South Yorkshire moves, hills and student areas" },
];

const hullAreas = hullAreaCandidates
...
const faqItems = [
  { q: "How much does a man and van cost in Hull?", a: "Hull moves typically start from £19 per hour. A straightforward local move usually costs £60–£130 depending on furniture volume, access (stairs, lifts, parking) and A63 traffic. A full 3-bed house move in Hull could be £250–£500. Submit your postcodes and item list for a guide price first, then a verified mover reviews the details and sends a quote." },
  ...
  { q: "How much does a man and van cost from Hull to York?", a: "A Hull to York move in 2026 typically costs £80–£180 depending on load, access and timing. The A1079 and A63 connect both cities in around 50–60 minutes. A single-item collection might start from £19–£80. Submit your postcodes and item list for a guide price." },
];

const serviceSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Man and Van Hull quote request",
  url: `${baseUrl}/man-and-van-hull`,
  provider: {
    "@type": "Organization",
  ...
  areaServed: {
    ...
    containsPlace: [
      ...
      { "@type": "Neighborhood", name: "Kingswood" },
      { "@type": "Neighborhood", name: "Beverley" },
      { "@type": "Neighborhood", name: "Newland Avenue" },
      { "@type": "Neighborhood", name: "Prince Avenue" },
      { "@type": "City", name: "York" },
  ...
  description:
    "Free Hull man and van request service. Customers can see a guide price, submit details securely and receive a quote from one verified mover before booking.",
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Man and Van Hull", item: `${baseUrl}/man-and-van-hull` },
  ],
};

const services = [
  { icon: <Truck size={24} />, title: "House Removals", desc: "Family homes, terraced houses and suburban relocations across Hull.", href: "/house-removals" },
  { icon: <Building2 size={24} />, title: "Flat Moves", desc: "City-centre apartments, A63 corridor flats and waterside moves.", href: "/flat-removals" },
  { icon: <GraduationCap size={24} />, title: "Student Moves", desc: "University of Hull student moves, June to September.", href: "/student-removals" },
    ...
    <main className="bg-white min-h-screen selection:bg-accent selection:text-white">
        ...
        <div className="container mx-auto px-4 py-3">
          <ol className="flex items-center gap-2 text-xs font-medium text-primary/50">
            ...
            <li className="flex items-center gap-2">
              ...
              <span className="text-primary font-bold">Man and Van Hull</span>
            </li>
          </ol>
        </div>
      </nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="space-y-8">
              <div className="flex flex-wrap items-center gap-3">
                <div className="inline-flex items-center gap-2 bg-accent/10 text-accent px-4 py-2 rounded-full text-[10px] font-black uppercase tracking-[0.28em] border border-accent/20"><MapPin size={14} /> East Yorkshire</div>
              ...
              <div className="space-y-5">
                <h1 className="text-4xl md:text-6xl font-black text-primary uppercase tracking-tighter leading-[0.95]">
                  Man and Van <span className="text-accent">Hull</span>
                </h1>
            ...
            <div className="bg-white rounded-[2rem] border border-border p-6 lg:p-8 space-y-5 shadow-sm">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-xl font-black uppercase tracking-tight text-primary">Hull moving challenges</h3>
                  <p className="text-sm text-text-secondary font-medium leading-relaxed mt-2">Hull moves involve tight terraced streets around the old town, A63 and Clive Sullivan Way corridor traffic, student areas near the University of Hull, and Humber Bridge approaches for cross-river moves. The form captures these details so your mover can plan properly.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 space-y-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
            <div className="bg-primary rounded-[2rem] p-8 lg:p-10 min-h-[260px] flex flex-col justify-center space-y-5 shadow-sm">
              <h2 className="text-3xl md:text-4xl font-black uppercase tracking-tight text-white leading-tight">Terraced streets, <span className="text-accent">A63</span> timing and student areas</h2>
              <p className="text-white/85 font-medium leading-relaxed text-base lg:text-lg">A move from a Newland Avenue terrace is different to a Kingswood family home, a Hessle riverside flat or a Beverley suburban house. The form asks for the details a mover needs: postcodes, items, helpers, stairs, lifts, access and date.</p>
            </div>
      ...
      <section className="py-16 bg-[#F9F9F7] border-y border-border">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-primary uppercase tracking-tight mt-4">Moving Services in Hull</h2>
          </div>
      ...
      {hullAreas.length > 0 && (
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 max-w-5xl">
            <div className="text-center mb-10">
              <span className="inline-block bg-accent/10 text-accent px-4 py-1.5 rounded-full text-[9px] font-black uppercase tracking-[0.35em]">Yorkshire</span>
              <h2 className="text-3xl md:text-4xl font-black text-primary uppercase tracking-tight mt-4">Man and Van in Yorkshire</h2>
              <p className="text-text-secondary mt-3 text-sm max-w-xl mx-auto">Hull is our East Yorkshire hub. We also cover York, Leeds and Sheffield — with more areas coming soon.</p>
            </div>
      ...
      <section className="py-16 bg-[#F9F9F7] border-y border-border">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-primary uppercase tracking-tight mt-4">Man and Van Prices in Hull (2026)</h2>
          </div>
            ...
            <table className="w-full border-collapse">
              ...
              <tbody className="divide-y divide-border">
                {[
                  ...
                  { type: "Hull to York", price: "£80–£180" },
                ].map((row, i) => (
      ...
      <section className="py-16 lg:py-24">
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="text-center mb-10 space-y-3">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-primary uppercase tracking-tight">Hull man and van questions</h2>
          </div>
          <FAQ items={faqItems} />
        </div>
      </section>
      ...
      <section className="py-16 bg-[#F9F9F7] border-t border-border text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-black text-primary uppercase tracking-tighter mb-4">Ready to Move in Hull?</h2>
