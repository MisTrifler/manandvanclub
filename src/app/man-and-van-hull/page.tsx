...
export const metadata: Metadata = {
  title: "Man and Van Hull From £19/hr | Free Quotes",
  description: "Man with a van in Hull from £19/hr. One verified mover reviews your details before you book. Rated 5.0/5 from 11 reviews. City centre, Anlaby, Cottingham, Hessle.",
  alternates: { canonical: `${baseUrl}/man-and-van-hull` },
  openGraph: {
    title: "Man and Van Hull From £19/hr | Free Quotes",
    description: "Man with a van in Hull from £19/hr. One verified mover reviews your details before you book. Rated 5.0/5 from 11 reviews.",
    url: `${baseUrl}/man-and-van-hull`,
    images: [{ url: `${baseUrl}/api/og?title=${encodeURIComponent("Man and Van Hull")}&subtitle=${encodeURIComponent("From £19/hr, Free Quotes")}`, width: 1200, height: 630, alt: "Man and Van Hull From £19/hr | Free Quotes" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Man and Van Hull From £19/hr | Free Quotes",
    description: "Man with a van in Hull from £19/hr. One verified mover reviews your details before you book. Rated 5.0/5 from 11 reviews.",
    images: [`${baseUrl}/api/og?title=${encodeURIComponent("Man and Van Hull")}&subtitle=${encodeURIComponent("From £19/hr, Free Quotes")}`],
  },
};
