...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/images/og-homepage.jpg", width: 1200, height: 630, alt: "Man and Van vs Removal Company Comparison" }],
  },
  twitter: {
            ...
            <table className="w-full border-collapse">
              ...
              <tbody className="divide-y divide-border">
                {[
                  ...
                  { factor: "Typical cost (single item)", manAndVan: "£35–£70", removal: "£150–£300 (minimum charge)" },
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse">
              ...
              <tbody className="divide-y divide-border">
                {[
                  { type: "Single item (local)", mv: "£35–£70", rc: "£150–£300", saving: "50–75%" },
