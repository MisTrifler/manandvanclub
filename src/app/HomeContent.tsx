...
export default function HomeContent() {
  ...
  const services = [
    ...
    { 
      ...
      i: "🏢", 
      h: "/flat-removals", 
      img: "https://images.unsplash.com/photo-1594481073154-949439ca68f9?q=80&w=800&auto=format&fit=crop" 
    },
    { 
      t: "Student Moves", 
            ...
            {services.map((s, i) => (
              <Link key={i} href={s.h} className="group bg-[#F9F9F7] rounded-[2.5rem] overflow-hidden border border-border/50 shadow-sm hover:shadow-2xl transition-all duration-500 flex flex-col h-full" onClick={() => window.scrollTo(0,0)}>
                <div className="relative aspect-[4/3] overflow-hidden">
                  <Image src={s.img} alt={s.t} fill className="object-cover group-hover:scale-110 transition-transform duration-1000" />
