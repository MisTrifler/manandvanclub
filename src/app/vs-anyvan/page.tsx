...
const faqItems = [
  ...
  },
  {
    ...
    a: "No. Man and Van Club does not set a minimum fee. The mover's quote is based on your actual move details — postcodes, items, access, stairs and timing. UK man and van rates in 2026 start from £34 per hour for local jobs."
  },
  {
