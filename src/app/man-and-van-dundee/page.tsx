...
export const metadata: Metadata = {
  ...
  description: "Man with a van in Dundee from £19/hr. One verified mover reviews your details before you book. Rated 5.0/5 from 5 reviews. City centre, Broughty Ferry, Lochee, Stobswell.",
  alternates: { canonical: `${baseUrl}/man-and-van-dundee` },
  openGraph: {
    title: "Man and Van Dundee From £19/hr | Free Quotes",
    description: "Man with a van in Dundee from £19/hr. One verified mover reviews your details before you book. Rated 5.0/5 from 5 reviews.",
