...
export const metadata: Metadata = {
  title: "Man and Van Dundee From £19/hr | Free Quotes",
  description: "Man with a van in Dundee from £19/hr. One verified mover reviews your details before you book. Rated 5.0/5 from 11 reviews. City centre, Broughty Ferry, Lochee, Stobswell.",
  alternates: { canonical: `${baseUrl}/man-and-van-dundee` },
  openGraph: {
    title: "Man and Van Dundee From £19/hr | Free Quotes",
    description: "Man with a van in Dundee from £19/hr. One verified mover reviews your details before you book. Rated 5.0/5 from 11 reviews.",
    url: `${baseUrl}/man-and-van-dundee`,
    images: [{ url: `${baseUrl}/api/og?title=${encodeURIComponent("Man and Van Dundee")}&subtitle=${encodeURIComponent("From £19/hr, Free Quotes")}`, width: 1200, height: 630, alt: "Man and Van Dundee From £19/hr | Free Quotes" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Man and Van Dundee From £19/hr | Free Quotes",
    description: "Man with a van in Dundee from £19/hr. One verified mover reviews your details before you book. Rated 5.0/5 from 11 reviews.",
    images: [`${baseUrl}/api/og?title=${encodeURIComponent("Man and Van Dundee")}&subtitle=${encodeURIComponent("From £19/hr, Free Quotes")}`],
  },
};
