...
export const metadata: Metadata = {
  title: "Man and Van Dundee | Verified Mover Quotes from £45",
  description: "Submit a free man and van request in Dundee. One verified mover reviews your details before you book. From £45/hr. City centre, Broughty Ferry, Lochee, Stobswell.",
  alternates: { canonical: `${baseUrl}/man-and-van-dundee` },
  openGraph: {
    title: "Man and Van Dundee | Verified Mover Quotes from £45",
    description: "Submit a free man and van request in Dundee. One verified mover reviews your details before you book. From £45/hr.",
    url: `${baseUrl}/man-and-van-dundee`,
    images: [{ url: `${baseUrl}/api/og?title=${encodeURIComponent("Man and Van Dundee")}&subtitle=${encodeURIComponent("Verified Mover Quotes from £45")}`, width: 1200, height: 630, alt: "Man and Van Dundee | Verified Mover Quotes from £45" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Man and Van Dundee | Verified Mover Quotes from £45",
    description: "Submit a free man and van request in Dundee. One verified mover reviews your details before you book. From £45/hr.",
    images: [`${baseUrl}/api/og?title=${encodeURIComponent("Man and Van Dundee")}&subtitle=${encodeURIComponent("Verified Mover Quotes from £45")}`],
  },
};

const dundeeAreaCandidates = [
  { slug: "dundee", name: "Dundee", note: "City-centre flats, student moves and A90 corridor" },
  { slug: "aberdeen", name: "Aberdeen", note: "Granite tenements, energy-sector relocations" },
...
const dundeeAreas = dundeeAreaCandidates
...
const faqItems = [
  { q: "How much does a man and van cost in Dundee?", a: "Dundee moves typically start from £45 per hour. A straightforward local move usually costs £60–£130 depending on furniture volume, access (stairs, lifts, parking) and A90 traffic. A full 3-bed house move in Dundee could be £250–£500. Submit your postcodes and item list for a guide price first, then a verified mover reviews the details and sends a quote." },
  ...
  { q: "Can I book a same-day man and van in Dundee?", a: "Same-day moves may be possible depending on mover availability, route and access. Dundee\u2019s Kingsway, A90 and the Tay Road Bridge approach are factored into route planning. Submit the request with the correct postcodes and move details so a verified mover can review it quickly." },
  { q: "Can I use this for single-item furniture collection?", a: "Yes. The Dundee service can be used for single items, furniture collection, student moves, flat moves, house removals, office moves and local storage runs." },
  { q: "Do you cover Broughty Ferry, Lochee and Stobswell?", a: "Yes. You can submit move requests for Broughty Ferry, Lochee, Stobswell, Menzieshill, Charleston, Monifieth and surrounding areas. A verified mover will review your request and can quote if they work in those areas." },
  { q: "Can you help with student moves in Dundee?", a: "Yes. Student moves can be submitted for areas near the University of Dundee campus, Abertay University and the city-centre student quarters. Peak demand is June, July and September. Add your item list, access notes and preferred dates for a verified mover to review." },
  { q: "How much does a man and van cost from Dundee to Edinburgh?", a: "A Dundee to Edinburgh move in 2026 typically costs £80–£180 depending on load, access and timing. The A90 and M90 connect both cities in around 60–75 minutes, crossing the Forth Road Bridge. A single-item collection might start from £45–£80. Submit your postcodes and item list for a guide price." },
];

const serviceSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Man and Van Dundee quote request",
  url: `${baseUrl}/man-and-van-dundee`,
  provider: {
    "@type": "Organization",
  ...
  areaServed: {
    ...
    containsPlace: [
      ...
      { "@type": "Neighborhood", name: "Charleston" },
      { "@type": "Neighborhood", name: "Monifieth" },
      { "@type": "Neighborhood", name: "Hilltown" },
  ...
  description:
    "Free Dundee man and van request service. Customers can see a guide price, submit details securely and receive a quote from one verified mover before booking.",
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Man and Van Dundee", item: `${baseUrl}/man-and-van-dundee` },
  ],
};

const services = [
  { icon: <Truck size={24} />, title: "House Removals", desc: "Family homes, tenement flats and suburban relocations across Dundee.", href: "/house-removals" },
  { icon: <Building2 size={24} />, title: "Flat Moves", desc: "Tenement flat moves, city-centre apartments and Broughty Ferry properties.", href: "/flat-removals" },
  { icon: <GraduationCap size={24} />, title: "Student Moves", desc: "University of Dundee and Abertay student moves, June to September.", href: "/student-removals" },
    ...
    <main className="bg-white min-h-screen selection:bg-accent selection:text-white">
        ...
        <div className="container mx-auto px-4 py-3">
          <ol className="flex items-center gap-2 text-xs font-medium text-primary/50">
            ...
            <li className="flex items-center gap-2">
              ...
              <span className="text-primary font-bold">Man and Van Dundee</span>
            </li>
          </ol>
        </div>
      </nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="space-y-8">
              <div className="flex flex-wrap items-center gap-3">
                <div className="inline-flex items-center gap-2 bg-accent/10 text-accent px-4 py-2 rounded-full text-[10px] font-black uppercase tracking-[0.28em] border border-accent/20"><MapPin size={14} /> East Scotland</div>
              ...
              <div className="space-y-5">
                <h1 className="text-4xl md:text-6xl font-black text-primary uppercase tracking-tighter leading-[0.95]">
                  Man and Van <span className="text-accent">Dundee</span>
                </h1>
            ...
            <div className="bg-white rounded-[2rem] border border-border p-6 lg:p-8 space-y-5 shadow-sm">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-xl font-black uppercase tracking-tight text-primary">Dundee moving challenges</h3>
                  <p className="text-sm text-text-secondary font-medium leading-relaxed mt-2">Dundee moves involve tenement flats with narrow closes in the Hilltown and Lochee areas, student neighbourhoods around the University of Dundee, the Kingsway ring road for cross-city moves, and the Tay Road Bridge approach for Fife-bound jobs. Broughty Ferry properties often have coastal access considerations. The form captures these details so your mover can plan properly.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 space-y-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
            <div className="bg-primary rounded-[2rem] p-8 lg:p-10 min-h-[260px] flex flex-col justify-center space-y-5 shadow-sm">
              <h2 className="text-3xl md:text-4xl font-black uppercase tracking-tight text-white leading-tight">Tenement closes, <span className="text-accent">Kingsway</span> ring road and student moves</h2>
              <p className="text-white/85 font-medium leading-relaxed text-base lg:text-lg">A move from a Hilltown tenement is different to a Broughty Ferry family home, a Stobswell terrace or a Monifieth suburban house. The form asks for the details a mover needs: postcodes, items, helpers, stairs, lifts, access and date.</p>
            </div>
      ...
      <section className="py-16 bg-[#F9F9F7] border-y border-border">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-primary uppercase tracking-tight mt-4">Moving Services in Dundee</h2>
          </div>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 max-w-5xl">
            <div className="text-center mb-10">
              ...
              <p className="text-text-secondary mt-3 text-sm max-w-xl mx-auto">Dundee is our east Scotland hub. We also cover Aberdeen, Edinburgh and Glasgow — with more areas coming soon.</p>
            </div>
      ...
      <section className="py-16 bg-[#F9F9F7] border-y border-border">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-primary uppercase tracking-tight mt-4">Man and Van Prices in Dundee (2026)</h2>
          </div>
            ...
            <table className="w-full border-collapse">
              ...
              <tbody className="divide-y divide-border">
                {[
                  ...
                  { type: "Dundee to Edinburgh", price: "£80–£180" },
                ].map((row, i) => (
      ...
      <section className="py-16 lg:py-24">
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="text-center mb-10 space-y-3">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-primary uppercase tracking-tight">Dundee man and van questions</h2>
          </div>
          <FAQ items={faqItems} />
        </div>
      </section>
      ...
      <section className="py-16 bg-[#F9F9F7] border-t border-border text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-black text-primary uppercase tracking-tighter mb-4">Ready to Move in Dundee?</h2>
