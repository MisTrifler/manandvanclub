...
export const metadata: Metadata = {
  title: "Man and Van Dundee | Verified Mover Quotes from £50",
  description: "Submit a free man and van request in Dundee. One verified mover reviews your details before you book. From £50/hr. City centre, Broughty Ferry, Lochee, Stobswell.",
  alternates: { canonical: `${baseUrl}/man-and-van-dundee` },
  openGraph: {
    title: "Man and Van Dundee | Verified Mover Quotes from £50",
    description: "Submit a free man and van request in Dundee. One verified mover reviews your details before you book. From £50/hr.",
    url: `${baseUrl}/man-and-van-dundee`,
    images: [{ url: `${baseUrl}/api/og?title=${encodeURIComponent("Man and Van Dundee")}&subtitle=${encodeURIComponent("Verified Mover Quotes from £50")}`, width: 1200, height: 630, alt: "Man and Van Dundee | Verified Mover Quotes from £50" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Man and Van Dundee | Verified Mover Quotes from £50",
    description: "Submit a free man and van request in Dundee. One verified mover reviews your details before you book. From £50/hr.",
    images: [`${baseUrl}/api/og?title=${encodeURIComponent("Man and Van Dundee")}&subtitle=${encodeURIComponent("Verified Mover Quotes from £50")}`],
  },
};
...
const faqItems = [
  { q: "How much does a man and van cost in Dundee?", a: "Dundee moves typically start from £50 per hour. A straightforward local move usually costs £60–£130 depending on furniture volume, access (stairs, lifts, parking) and A90 traffic. A full 3-bed house move in Dundee could be £250–£500. Submit your postcodes and item list for a guide price first, then a verified mover reviews the details and sends a quote." },
