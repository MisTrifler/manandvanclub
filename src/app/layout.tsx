...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: "Man and Van Club | Moving Home From £45 | Verified UK Movers",
    description: "Moving home? Man and van from £45/hr. Verified movers for house removals, flat moves, furniture delivery and same-day jobs across the UK.",
    images: [
      {
  ...
  twitter: {
    ...
    title: "Man and Van Club | Moving Home From £45 | Verified UK Movers",
    description: "Moving home? Man and van from £45/hr. Verified UK movers for house removals, flat moves, furniture delivery and same-day jobs.",
