...
const faqItems = [
  ...
  { q: "Why does same-day cost more?", a: "Same-day moves typically carry a 15–30% premium because the mover may need to rearrange their schedule, and availability is more limited. Same-day man and van rates in 2026 start from £55 per hour, compared to £45 for standard bookings." },
  { q: "How much does a man and van cost per hour in the UK?", a: "In 2026, UK man and van hourly rates typically range from £45 to £70 per hour outside London, and £55 to £80 per hour in London. Rates depend on van size, number of helpers, distance, access and time of day." },
