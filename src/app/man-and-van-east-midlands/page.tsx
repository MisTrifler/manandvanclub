...
const faqItems = [
  {
    ...
    a: "The guide price depends on the collection and delivery postcodes, distance, item list, helpers required, stairs, parking and access. East Midlands rates in 2026 start from £50 per hour, with full-day costs around £350–£500. You can see a guide price first, then a verified mover reviews the details and sends a quote before you decide whether to book.",
  },
  {
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                ...
                <div className="flex items-center gap-3 bg-white rounded-xl border border-border px-4 py-3">
                  ...
                  <span className="text-xs font-bold uppercase tracking-wider text-primary">From £50/hr</span>
                </div>
              </div>
            </div>
