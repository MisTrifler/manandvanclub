...
export const metadata: Metadata = {
  ...
  description:
    "Man with a van in the East Midlands from £19/hr. Get a guide price, keep your details private, and receive a quote from one verified mover before you book. Rated 5.0/5 from 6 reviews. Covers Nottingham, Leicester, Derby, Northampton, Lincoln and surrounding areas.",
  alternates: {
