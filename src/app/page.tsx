          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
            ...
            >
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-black mb-6 leading-[0.95] text-primary tracking-tighter uppercase">
                The Smarter Way To{" "}
                <span className="text-accent">Move Anything</span>{" "}
                Anywhere In The UK
              </h1>

              {/* Subheadline */}
              <p className="text-lg md:text-xl text-text-secondary mb-8 max-w-xl font-medium leading-relaxed">
                Submit your move request in under 60 seconds. We connect you 
                directly with a vetted local mover — no auctions, no middlemen, 
                no stress.
              </p>
