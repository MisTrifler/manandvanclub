...
export const metadata: Metadata = {
  ...
  description:
    "Man with a van nationwide from £19/hr. House removals, flat moves, furniture delivery and same-day jobs. One verified mover quotes — no spam calls. Rated 5.0 on Google. Call 0121 751 1269.",
  alternates: {
    canonical: siteUrl,
  },
  openGraph: {
