...
const servicePageData: Record<string, any> = {
  ...
  "same-day-man-and-van": {
    ...
    faq: [
      ...
      { q: "Does same-day cost more?", a: "Same-day moves in 2026 can cost 15–30% more than booked-ahead moves when availability is limited or the route is longer. UK same-day man and van rates start from £55 per hour, compared to £34 for a driver-helps standard booking or £19 for self-loading. You can see a guide price first, then the mover quote is shown before you decide whether to book." },
  ...
  "facebook-marketplace-collection": {
    ...
    faq: [
      ...
      { q: "How much does a marketplace collection cost?", a: "In 2026, Facebook Marketplace collections in the UK start from £19 for a single local item (sofa, bed, wardrobe or appliance). Longer-distance collections or multi-item pickups cost more. Add item dimensions and access details for an accurate guide price." },
      ...
      { q: "How much does a sofa collection from Facebook Marketplace cost?", a: "A local sofa collection in 2026 starts from £19, depending on sofa size, whether it needs dismantling, stairs at either address and parking access. Corner sofas and recliners cost more due to handling. Submit your postcodes and sofa details for a guide price." }
    ]
  },
  "piano-removals": {
    name: "Piano Removals",
  ...
  "single-item-delivery": {
    ...
    popularLocations,
    faq: [
      { q: "How much does single item delivery cost?", a: "In 2026, UK single item delivery prices start from £19 for a local collection within the same town or city. Longer distances, heavy items, stairs and awkward access increase the price. A sofa delivered across London might cost £70–£120, while a washing machine delivered within Birmingham might cost £19–£80. Submit your item details for a guide price." },
      ...
      { q: "Is single item delivery cheaper than a full move?", a: "Yes. A single item delivery is typically the most affordable man and van service, starting from £19 for a local job. Full house moves start from £300+ because of the time and volume involved." },
