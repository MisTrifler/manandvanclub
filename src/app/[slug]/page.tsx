...
const servicePageData: Record<string, any> = {
  "house-removals": {
    name: "House Removals",
    formIntent: "house",
    title: "House Removals | From £50 | Full Home Move Requests | Man and Van Club",
    description: "Full house removal quote requests across the UK from £50. Submit bedrooms, access, packing and postcodes so an approved mover can review your home move before quoting. Call 0121 751 1269.",
  ...
  "flat-removals": {
    name: "Flat Removals",
    formIntent: "house",
    title: "Flat Removals | From £50 | Apartment & Flat Move Requests | Man and Van Club",
    description: "Flat and apartment move requests across the UK from £50. Add lift access, parking restrictions and staircase details so an approved mover can quote accurately. Call 0121 751 1269.",
  ...
  "furniture-delivery": {
    ...
    title: "Furniture Collection & Delivery | From £50 | Single Item Movers | Man and Van Club",
  ...
  "same-day-man-and-van": {
    ...
    formIntent: "general",
    title: "Same Day Man and Van | From £50 | Fast Local Move Quotes | Man and Van Club",
