...
const servicePageData: Record<string, any> = {
  "house-removals": {
    ...
    description: "Full house removal quote requests across the UK. Submit bedrooms, access, packing and postcodes so an approved mover can review your home move before quoting.",
  ...
  "flat-removals": {
    ...
    description: "Flat and apartment move requests across the UK. Add lift access, parking restrictions and staircase details so an approved mover can quote accurately.",
  ...
  "student-removals": {
    ...
    description: "Student move quote requests across the UK. Moving to or from university halls or a shared house? Submit your details so an approved mover can review the job before quoting.",
  ...
  "office-removals": {
    ...
    description: "Office removal and business relocation quote requests across the UK. Add access, timing and equipment details so an approved mover can review the job before quoting.",
  ...
  "furniture-delivery": {
    ...
    description: "Furniture collection and delivery quote requests across the UK. From one bulky item to multiple furniture pieces, submit details so an approved mover can review before quoting.",
  ...
  "facebook-marketplace-collection": {
    ...
    description: "Collection and delivery quote requests for Facebook Marketplace purchases across the UK. Submit item and postcode details so an approved mover can review the job before quoting.",
...
export async function generateStaticParams() {
  ...
  const hubSlugs = new Set([
    ...
    'hull', 'york', 'aberdeen', 'swansea', 'dundee',
  ]);
