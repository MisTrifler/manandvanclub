...
export const metadata: Metadata = {
  title: "Man and Van Stoke-on-Trent | Verified Mover Quotes from £45",
  description: "Submit a free man and van request in Stoke-on-Trent. One verified mover reviews your details before you book. From £45/hr. Hanley, Burslem, Tunstall, Longton, Fenton.",
  alternates: { canonical: `${baseUrl}/man-and-van-stoke-on-trent` },
  openGraph: {
    title: "Man and Van Stoke-on-Trent | Verified Mover Quotes from £45",
    description: "Submit a free man and van request in Stoke-on-Trent. One verified mover reviews your details before you book. From £45/hr.",
    url: `${baseUrl}/man-and-van-stoke-on-trent`,
    images: [{ url: `${baseUrl}/api/og?title=${encodeURIComponent("Man and Van Stoke-on-Trent")}&subtitle=${encodeURIComponent("Verified Mover Quotes from £45")}`, width: 1200, height: 630, alt: "Man and Van Stoke-on-Trent | Verified Mover Quotes from £45" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Man and Van Stoke-on-Trent | Verified Mover Quotes from £45",
    description: "Submit a free man and van request in Stoke-on-Trent. One verified mover reviews your details before you book. From £45/hr.",
    images: [`${baseUrl}/api/og?title=${encodeURIComponent("Man and Van Stoke-on-Trent")}&subtitle=${encodeURIComponent("Verified Mover Quotes from £45")}`],
  },
};
...
const faqItems = [
  { q: "How much does a man and van cost in Stoke-on-Trent?", a: "Stoke-on-Trent moves typically start from £45 per hour. A straightforward local move usually costs £60–£130 depending on furniture volume, access (stairs, lifts, parking) and A500 traffic. A full 3-bed house move in Stoke could be £250–£500. Submit your postcodes and item list for a guide price first, then a verified mover reviews the details and sends a quote." },
...
const services = [
  ...
  { icon: <Sofa size={24} />, title: "Furniture Delivery", desc: "Single-item collections, marketplace pickups and IKEA runs.", href: "/furniture-delivery" },
