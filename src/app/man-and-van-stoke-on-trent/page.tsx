...
export const metadata: Metadata = {
  ...
  description: "Man with a van in Stoke-on-Trent from £19/hr. One verified mover reviews your details before you book. Rated 5.0/5 from 5 reviews. Hanley, Burslem, Tunstall, Longton, Fenton.",
  alternates: { canonical: `${baseUrl}/man-and-van-stoke-on-trent` },
  openGraph: {
    title: "Man and Van Stoke-on-Trent From £19/hr | Free Quotes",
    description: "Man with a van in Stoke-on-Trent from £19/hr. One verified mover reviews your details before you book. Rated 5.0/5 from 5 reviews.",
