...
export const metadata: Metadata = {
  title: "Man and Van Newcastle Prices 2026 | Man and Van Club",
...
export default function BlogPost() {
  return (
    <>
      ...
      <BlogPostLayout
        cityGuideHref="/blog/man-and-van-newcastle-prices-how-to-book"
        title="Man and Van Newcastle upon Tyne: Prices & How to Book (2026)"
      ...
      >
        <div className="text-text-secondary leading-relaxed space-y-6">
          ...
          <p>
            Newcastle man and van rates start from <strong className="text-primary">£19 per hour</strong>. Typical ranges:
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li><strong className="text-primary">Single item collection</strong> — from £19. A fridge from Gosforth to Fenham, for example.</li>
