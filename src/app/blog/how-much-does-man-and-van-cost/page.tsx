      ...
      >
        ...
        <div className="text-text-secondary leading-relaxed space-y-6">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li><strong className="text-primary">West Midlands</strong> — from £34 per hour. Birmingham, Walsall, Wolverhampton and Coventry typically fall in this range.</li>
            <li><strong className="text-primary">East Midlands</strong> — from £34 per hour. Nottingham, Leicester, Derby and Northampton.</li>
            ...
            <li><strong className="text-primary">Greater Manchester</strong> — from £34 per hour. Manchester, Salford, Stockport and Bolton.</li>
            <li><strong className="text-primary">Other UK cities</strong> — from £34 per hour. Leeds, Liverpool, Bristol, Sheffield, Edinburgh, Glasgow, Cardiff and most other UK towns and cities.</li>
          </ul>
          <p>
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li><strong className="text-primary">Studio flat, same city</strong> — typically 1–2 hours from £34–£110 (or from £55–£120 in London)</li>
            ...
            <li><strong className="text-primary">Single item collection</strong> — typically 1 hour from £34 (or from £55 in London)</li>
          </ul>
