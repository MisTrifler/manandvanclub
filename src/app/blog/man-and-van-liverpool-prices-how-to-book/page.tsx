...
export const metadata: Metadata = {
  title: "Man and Van Liverpool Prices 2026 | Man and Van Club",
    ...
    <>
      ...
      >
        <div className="text-text-secondary leading-relaxed space-y-6">
          ...
          <p>
            Liverpool man and van rates start from <strong className="text-primary">£19 per hour</strong>. Typical price ranges:
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li><strong className="text-primary">Single item collection</strong> — from £19. A desk from Aigburth to Childwall, for example.</li>
