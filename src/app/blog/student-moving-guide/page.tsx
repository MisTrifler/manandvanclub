    ...
    <>
      ...
      >
        <div className="text-text-secondary leading-relaxed space-y-6">
          ...
          <p>
            A student move — typically boxes, suitcases and small furniture from a shared house or halls — usually takes 1–2 hours with a man and van. At £50 per hour (or £55 in London), that means a total cost of roughly £50–£110 (or £55–£120 in London).
          </p>
          <p>
