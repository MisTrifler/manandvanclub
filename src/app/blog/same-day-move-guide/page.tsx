    ...
    <>
      ...
      >
        <div className="text-text-secondary leading-relaxed space-y-6">
          ...
          <p>Same-day moves typically carry a small premium because the mover may need to reroute their day. In 2026, expect to pay from £55/hr for a same-day job, compared to from £19/hr for a planned move.</p>
