...
export const metadata: Metadata = {
  title: "Man and Van Walsall: Prices & How to Book (2026) | Man and Van Club",
  description:
    ...
    <>
      ...
      >
        <div className="text-text-secondary leading-relaxed space-y-6">
          ...
          <p>
            Walsall rates start from <strong className="text-primary">£34 per hour</strong>, which is in line with the wider West Midlands average. Being slightly outside Birmingham means parking tends to be easier and travel times shorter, which can help keep costs down compared to city-centre moves. Here's what typical Walsall moves cost:
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li><strong className="text-primary">Single item collection or delivery</strong> — from £34. Picking up a sofa from a shop on High Street, or moving a washing machine between WS postcodes.</li>
