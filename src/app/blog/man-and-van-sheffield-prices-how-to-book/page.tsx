    ...
    <>
      ...
      >
        <div className="text-text-secondary leading-relaxed space-y-6">
          ...
          <p>
            Sheffield man and van rates typically start from <strong className="text-primary">£50 per hour</strong>. That's the going rate for a standard van with one mover doing local work within the city. Most Sheffield moves fall into these ranges:
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li><strong className="text-primary">Single item collection</strong> — from £50. A sofa picked up from Meadowhall and delivered to Heeley, for example.</li>
