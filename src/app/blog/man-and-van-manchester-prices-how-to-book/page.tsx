    ...
    <>
      ...
      >
        <div className="text-text-secondary leading-relaxed space-y-6">
          ...
          <p>
            Manchester rates start from <strong className="text-primary">£50 per hour</strong>, in line with the wider North West average. The city centre commands slightly more than suburban areas, but overall Manchester is cheaper than London and comparable to Birmingham. Typical moves cost:
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li><strong className="text-primary">Single item collection or delivery</strong> — from £50. Picking up a wardrobe from a shop in the Arndale or delivering a sofa to Sale.</li>
