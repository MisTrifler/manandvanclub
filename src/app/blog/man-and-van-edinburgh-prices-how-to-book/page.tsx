...
export const metadata: Metadata = {
  title: "Man and Van Edinburgh: Prices & How to Book (2026) | Man and Van Club",
    ...
    <>
      ...
      >
        <div className="text-text-secondary leading-relaxed space-y-6">
          ...
          <p>
            Edinburgh man and van rates start from <strong className="text-primary">£34 per hour</strong>. Typical ranges:
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li><strong className="text-primary">Single item collection</strong> — from £34. A sofa from Leith to Morningside, for example.</li>
