...
export const metadata: Metadata = {
  title: "Man and Van Bristol Prices 2026 | Man and Van Club",
...
export default function BlogPost() {
  return (
    <>
      ...
      <BlogPostLayout
        cityGuideHref="/blog/man-and-van-bristol-prices-how-to-book"
        title="Man and Van Bristol: Prices & How to Book (2026)"
      ...
      >
        <div className="text-text-secondary leading-relaxed space-y-6">
          ...
          <p>
            Bristol man and van rates start from <strong className="text-primary">£19 per hour</strong> for local work with a standard van and one mover. Typical price ranges:
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li><strong className="text-primary">Single item collection</strong> — from £19. A wardrobe collected from Horfield and delivered to Knowle.</li>
