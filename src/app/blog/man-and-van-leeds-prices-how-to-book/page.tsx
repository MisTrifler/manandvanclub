...
export default function BlogPost() {
  return (
    <>
      ...
      <BlogPostLayout
        cityGuideHref="/blog/man-and-van-leeds-prices-how-to-book"
        title="Man and Van Leeds: Prices & How to Book (2026)"
      ...
      >
        <div className="text-text-secondary leading-relaxed space-y-6">
          ...
          <p>
            Leeds rates start from <strong className="text-primary">£19 per hour</strong>, consistent with the wider Yorkshire and North West market. The city is slightly cheaper than Manchester for most moves, and significantly cheaper than London. Typical costs:
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li><strong className="text-primary">Single item collection or delivery</strong> — from £19. A washing machine from Leeds city centre to Headingley, or a sofa from a shop in Crown Point.</li>
