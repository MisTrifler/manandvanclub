      ...
      >
        <div className="text-text-secondary leading-relaxed space-y-6">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li><strong className="text-primary">Single item:</strong> Sofa, bed, appliance — from £50</li>
          ...
          <p>Need a mover today? Same-day availability depends on whether a verified mover has a gap in their schedule. Because the mover may need to reroute or adjust their day, same-day jobs typically carry a premium — expect to pay from £55/hr rather than the standard £50/hr. <Link href="/same-day-man-and-van" className="text-accent hover:underline">Same-day man and van</Link> requests submitted early in the day have a better chance of being picked up.</p>
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li><strong className="text-primary">West Midlands:</strong> From £50/hr — competitive rates due to high mover availability</li>
            <li><strong className="text-primary">London:</strong> From £55/hr — ULEZ, Congestion Charge and higher operating costs</li>
            <li><strong className="text-primary">North West (Manchester, Liverpool):</strong> From £50/hr</li>
            <li><strong className="text-primary">Scotland (Edinburgh, Glasgow):</strong> From £50/hr</li>
            <li><strong className="text-primary">South West (Bristol, Bath):</strong> From £50/hr</li>
