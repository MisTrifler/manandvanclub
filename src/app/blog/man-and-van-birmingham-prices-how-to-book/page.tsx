    ...
    <>
      ...
      >
        <div className="text-text-secondary leading-relaxed space-y-6">
          ...
          <p>
            Birmingham man and van rates typically start from <strong className="text-primary">£34 per hour</strong>. That's the baseline for a standard van with one mover doing local work within the city. Most Birmingham moves fall into these ranges:
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li><strong className="text-primary">Single item collection</strong> — from £34. A sofa from the Bull Ring area to a flat in Selly Oak, for example.</li>
