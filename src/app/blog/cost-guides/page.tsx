...
const costPosts = [
  ...
  },
  {
    ...
    description: "Current Birmingham man and van prices, what affects the cost, local area tips and how to book a verified mover for your next move in Birmingham.",
    date: "2026-07-16",
    readTime: "7 min read",
  },
  {
    ...
    description: "Current Walsall man and van prices, local area tips, how to book a verified mover and what to have ready before your move day in Walsall.",
    date: "2026-07-16",
    readTime: "6 min read",
  },
  {
