...
const blogPosts = [
  ...
  },
  {
    ...
    description:
      "Current Leicester man and van prices, what affects the cost — terraces, two universities and match-day traffic — and how to book a verified mover for your next move in Leicester.",
    date: "2026-07-23",
    readTime: "7 min read",
    category: "Cost Guides",
  },
