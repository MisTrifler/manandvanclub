...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "UK man and van costs broken down by setup, move type, region and access. From £19/hr. Get a free guide price before you book.",
  ...
  twitter: {
    ...
    title: "How Much Does a Man and Van Cost? | Cheapest UK Prices 2026",
    description: "UK man and van costs broken down by move type, region and access. From £19/hr.",
...
const faqItems = [
  {
    ...
    a: "The cheapest man and van option is a self-loading service with one driver and a small transit van, where you carry all items to and from the van yourself. Rates start from £19 per hour. If you need the driver to help with loading and carrying, expect £34–£55 per hour. On Man and Van Club, quotes start from £19/hr for self-loading or £34/hr for a driver-helps service across most of the UK.",
  },
  {
  ...
  },
  {
    ...
    a: "A single-item collection or delivery starts from £19 in most UK areas. This covers a sofa, bed frame, washing machine or similar. The price may increase if the item is very heavy (piano), needs two people, or is being moved a long distance between postcodes.",
  },
  {
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="bg-white rounded-2xl border border-border overflow-hidden">
            <table className="w-full text-left">
              ...
              <tbody className="divide-y divide-border/50">
                {[
                  { setup: "1 man + small van (you load)", rate: "From £19/hr", best: "Single items, Facebook Marketplace collections, student moves" },
          ...
          <p className="text-xs text-text-secondary text-center mt-4">
            Man and Van Club quotes start from £19/hr for self-loading or £34/hr for a driver-helps service. Most budget operators require a 2-hour minimum booking.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              { region: "South West", rate: "From £19/hr", cities: "Bristol, Exeter, Plymouth, Bournemouth", note: "Bristol is the priciest in the region. Rural Devon and Cornwall moves may carry a minimum charge due to distance." },
              { region: "North East", rate: "From £19/hr", cities: "Newcastle, Sunderland, Durham, Middlesbrough", note: "Affordable rates. Newcastle city centre has some parking restrictions but overall lower than the South." },
            ].map((item) => (
