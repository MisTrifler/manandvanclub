...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "UK man and van costs broken down by move type, region and access. From £50/hr. Get a free guide price before you book.",
  ...
  twitter: {
    ...
    title: "How Much Does a Man and Van Cost? | UK Prices 2026",
    description: "UK man and van costs broken down by move type, region and access. From £50/hr.",
...
const faqItems = [
  {
    ...
    a: "In 2026, UK man and van rates start from £50 per hour outside London. London rates start from £55 per hour due to Congestion Charge, ULEZ and higher parking costs. Most local moves take 2–4 hours, so you're typically looking at £100–£280 for a straightforward job.",
  },
  {
  ...
  },
  {
    ...
    a: "A single-item collection or delivery starts from £50 in most UK areas. This covers a sofa, bed frame, washing machine or similar. The price may increase if the item is very heavy (piano), needs two people, or is being moved a long distance between postcodes.",
  },
  {
          ...
          <div className="bg-[#F9F9F7] rounded-2xl border border-border overflow-hidden">
            <table className="w-full text-left">
              ...
              <tbody className="divide-y divide-border/50">
                {[
                  { type: "Hourly rate (outside London)", price: "From £50/hr" },
                  { type: "Hourly rate (London)", price: "From £55/hr" },
                  { type: "Single item collection/delivery", price: "From £50" },
      ...
      <section className="py-16 bg-[#F9F9F7] border-y border-border">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              { region: "West Midlands", rate: "From £50/hr", cities: "Birmingham, Walsall, Wolverhampton, Coventry, Dudley", note: "Generally the most affordable area in the UK for man and van hire. Good road access via M6/M5/A38." },
              { region: "East Midlands", rate: "From £50/hr", cities: "Nottingham, Leicester, Derby, Northampton", note: "Comparable to West Midlands. Student areas (Nottingham, Leicester) see peak demand June–September." },
              ...
              { region: "Greater Manchester", rate: "From £50/hr", cities: "Manchester, Salford, Bolton, Stockport, Oldham", note: "City centre parking and M60 congestion can add time. Suburban areas like Altrincham and Stockport are usually cheaper." },
              { region: "Yorkshire", rate: "From £50/hr", cities: "Leeds, Sheffield, Bradford, Hull, Huddersfield", note: "Competitive pricing across Yorkshire. Back-to-back terraces in Leeds and Bradford slow loading down." },
              { region: "Scotland", rate: "From £50/hr", cities: "Edinburgh, Glasgow, Aberdeen, Dundee", note: "Edinburgh Old Town and Glasgow West End have narrow streets and permit zones. Aberdeen and Dundee are typically cheaper." },
              { region: "South West", rate: "From £50/hr", cities: "Bristol, Exeter, Plymouth, Bournemouth", note: "Bristol is the priciest in the region. Rural Devon and Cornwall moves may carry a minimum charge due to distance." },
              { region: "North East", rate: "From £50/hr", cities: "Newcastle, Sunderland, Durham, Middlesbrough", note: "Affordable rates. Newcastle city centre has some parking restrictions but overall lower than the South." },
            ].map((item) => (
