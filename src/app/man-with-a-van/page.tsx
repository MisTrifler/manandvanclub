...
const faqItems = [
  ...
  },
  {
    ...
    a: "We cover 488 areas across England, Scotland, Wales and Northern Ireland — from major cities to smaller towns and suburbs. Submit your collection and delivery postcodes for free and a verified local mover can check the route and send quote options.",
  },
];
    ...
    <main className="min-h-screen">
      ...
      <section className="py-12 lg:py-14 bg-white border-b border-border">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <p className="text-sm text-text-secondary text-center max-w-2xl mx-auto mb-8 font-medium">488 UK areas covered — from city centres to smaller towns and suburbs. These are some of the busiest:</p>
          <div className="flex flex-wrap justify-center gap-2">
            ...
            <Link href="/areas-covered" className="inline-flex items-center gap-1.5 bg-accent text-white rounded-full px-4 py-2 text-xs font-black hover:opacity-90 transition-opacity">
              View all 488 areas <ArrowUpRight size={12} />
            </Link>
          </div>
        </div>
      </section>
