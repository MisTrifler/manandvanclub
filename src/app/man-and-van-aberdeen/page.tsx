...
export const metadata: Metadata = {
  title: "Man and Van Aberdeen | Verified Mover Quotes from £19",
  description: "Submit a free man and van request in Aberdeen. One verified mover reviews your details before you book. From £19/hr. City centre, West End, Bridge of Don, Cults.",
  alternates: { canonical: `${baseUrl}/man-and-van-aberdeen` },
  openGraph: {
    title: "Man and Van Aberdeen | Verified Mover Quotes from £19",
    description: "Submit a free man and van request in Aberdeen. One verified mover reviews your details before you book. From £19/hr.",
    url: `${baseUrl}/man-and-van-aberdeen`,
    images: [{ url: `${baseUrl}/api/og?title=${encodeURIComponent("Man and Van Aberdeen")}&subtitle=${encodeURIComponent("Verified Mover Quotes from £19")}`, width: 1200, height: 630, alt: "Man and Van Aberdeen | Verified Mover Quotes from £19" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Man and Van Aberdeen | Verified Mover Quotes from £19",
    description: "Submit a free man and van request in Aberdeen. One verified mover reviews your details before you book. From £19/hr.",
    images: [`${baseUrl}/api/og?title=${encodeURIComponent("Man and Van Aberdeen")}&subtitle=${encodeURIComponent("Verified Mover Quotes from £19")}`],
  },
};
