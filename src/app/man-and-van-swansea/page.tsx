...
export const metadata: Metadata = {
  ...
  description: "Man with a van in Swansea from £19/hr. One verified mover reviews your details before you book. Rated 5.0/5 from 6 reviews. City centre, Uplands, Sketty, Mumbles.",
  alternates: { canonical: `${baseUrl}/man-and-van-swansea` },
  openGraph: {
    title: "Man and Van Swansea From £19/hr | Free Quotes",
    description: "Man with a van in Swansea from £19/hr. One verified mover reviews your details before you book. Rated 5.0/5 from 6 reviews.",
