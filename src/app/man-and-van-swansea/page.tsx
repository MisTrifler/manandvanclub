...
export const metadata: Metadata = {
  title: "Man and Van Swansea | Verified Mover Quotes from £50",
  description: "Submit a free man and van request in Swansea. One verified mover reviews your details before you book. From £50/hr. City centre, Uplands, Sketty, Mumbles.",
  alternates: { canonical: `${baseUrl}/man-and-van-swansea` },
  openGraph: {
    title: "Man and Van Swansea | Verified Mover Quotes from £50",
    description: "Submit a free man and van request in Swansea. One verified mover reviews your details before you book. From £50/hr.",
    url: `${baseUrl}/man-and-van-swansea`,
    images: [{ url: `${baseUrl}/api/og?title=${encodeURIComponent("Man and Van Swansea")}&subtitle=${encodeURIComponent("Verified Mover Quotes from £50")}`, width: 1200, height: 630, alt: "Man and Van Swansea | Verified Mover Quotes from £50" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Man and Van Swansea | Verified Mover Quotes from £50",
    description: "Submit a free man and van request in Swansea. One verified mover reviews your details before you book. From £50/hr.",
    images: [`${baseUrl}/api/og?title=${encodeURIComponent("Man and Van Swansea")}&subtitle=${encodeURIComponent("Verified Mover Quotes from £50")}`],
  },
};
...
const faqItems = [
  { q: "How much does a man and van cost in Swansea?", a: "Swansea moves typically start from £50 per hour. A straightforward local move usually costs £60–£130 depending on furniture volume, access (stairs, lifts, parking) and M4 traffic. A full 3-bed house move in Swansea could be £250–£500. Submit your postcodes and item list for a guide price first, then a verified mover reviews the details and sends a quote." },
  ...
  { q: "How much does a man and van cost from Swansea to Cardiff?", a: "A Swansea to Cardiff move in 2026 typically costs £80–£180 depending on load, access and timing. The M4 and A48 connect both cities in around 45–55 minutes. A single-item collection might start from £50–£80. Submit your postcodes and item list for a guide price." },
];
