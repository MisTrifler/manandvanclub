...
export const metadata: Metadata = {
  title: "Man and Van Swansea | Verified Mover Quotes from £19",
  description: "Submit a free man and van request in Swansea. One verified mover reviews your details before you book. From £19/hr. City centre, Uplands, Sketty, Mumbles.",
  alternates: { canonical: `${baseUrl}/man-and-van-swansea` },
  openGraph: {
    title: "Man and Van Swansea | Verified Mover Quotes from £19",
    description: "Submit a free man and van request in Swansea. One verified mover reviews your details before you book. From £19/hr.",
    url: `${baseUrl}/man-and-van-swansea`,
    images: [{ url: `${baseUrl}/api/og?title=${encodeURIComponent("Man and Van Swansea")}&subtitle=${encodeURIComponent("Verified Mover Quotes from £19")}`, width: 1200, height: 630, alt: "Man and Van Swansea | Verified Mover Quotes from £19" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Man and Van Swansea | Verified Mover Quotes from £19",
    description: "Submit a free man and van request in Swansea. One verified mover reviews your details before you book. From £19/hr.",
    images: [`${baseUrl}/api/og?title=${encodeURIComponent("Man and Van Swansea")}&subtitle=${encodeURIComponent("Verified Mover Quotes from £19")}`],
  },
};

const swanseaAreaCandidates = [
  { slug: "swansea", name: "Swansea", note: "Coastal city moves, student areas and M4 corridor" },
  { slug: "cardiff", name: "Cardiff", note: "Capital city moves, bay area and city-centre flats" },
  { slug: "bristol", name: "Bristol", note: "Cross-border moves via M4 and Severn Bridge" },
  { slug: "aberdeen", name: "Aberdeen", note: "North-east Scotland hub" },
];

const swanseaAreas = swanseaAreaCandidates
...
const faqItems = [
  { q: "How much does a man and van cost in Swansea?", a: "Swansea moves typically start from £19 per hour. A straightforward local move usually costs £60–£130 depending on furniture volume, access (stairs, lifts, parking) and M4 traffic. A full 3-bed house move in Swansea could be £250–£500. Submit your postcodes and item list for a guide price first, then a verified mover reviews the details and sends a quote." },
  ...
  { q: "Can I book a same-day man and van in Swansea?", a: "Same-day moves may be possible depending on mover availability, route and access. Swansea\u2019s M4 corridor, A483 and the A4067 are factored into route planning. Submit the request with the correct postcodes and move details so a verified mover can review it quickly." },
  { q: "Can I use this for single-item furniture collection?", a: "Yes. The Swansea service can be used for single items, furniture collection, student moves, flat moves, house removals, office moves and local storage runs." },
  { q: "Do you cover Uplands, Sketty and Mumbles?", a: "Yes. You can submit move requests for Uplands, Sketty, Mumbles, Brynmill, Killay, Gorseinon and surrounding areas. A verified mover will review your request and can quote if they work in those areas." },
  { q: "Can you help with student moves in Swansea?", a: "Yes. Student moves can be submitted for areas near Swansea University campuses at Singleton Park and Bay Campus, Uplands and Brynmill. Peak demand is June, July and September. Add your item list, access notes and preferred dates for a verified mover to review." },
  { q: "How much does a man and van cost from Swansea to Cardiff?", a: "A Swansea to Cardiff move in 2026 typically costs £80–£180 depending on load, access and timing. The M4 and A48 connect both cities in around 45–55 minutes. A single-item collection might start from £19–£80. Submit your postcodes and item list for a guide price." },
];

const serviceSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Man and Van Swansea quote request",
  url: `${baseUrl}/man-and-van-swansea`,
  provider: {
    "@type": "Organization",
  ...
  description:
    "Free Swansea man and van request service. Customers can see a guide price, submit details securely and receive a quote from one verified mover before booking.",
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Man and Van Swansea", item: `${baseUrl}/man-and-van-swansea` },
  ],
};

const services = [
  { icon: <Truck size={24} />, title: "House Removals", desc: "Family homes, coastal properties and suburban relocations across Swansea.", href: "/house-removals" },
  { icon: <Building2 size={24} />, title: "Flat Moves", desc: "City-centre apartments, Uplands flats and Mumbles properties.", href: "/flat-removals" },
  { icon: <GraduationCap size={24} />, title: "Student Moves", desc: "Swansea University student moves, June to September.", href: "/student-removals" },
  { icon: <Sofa size={24} />, title: "Furniture Delivery", desc: "Single-item collections, marketplace pickups and store deliveries.", href: "/furniture-delivery" },
...
export default function SwanseaPage() {
  return (
    <main className="bg-white min-h-screen selection:bg-accent selection:text-white">
        ...
        <div className="container mx-auto px-4 py-3">
          <ol className="flex items-center gap-2 text-xs font-medium text-primary/50">
            ...
            <li className="flex items-center gap-2">
              ...
              <span className="text-primary font-bold">Man and Van Swansea</span>
            </li>
          </ol>
        </div>
      </nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="space-y-8">
              <div className="flex flex-wrap items-center gap-3">
                <div className="inline-flex items-center gap-2 bg-accent/10 text-accent px-4 py-2 rounded-full text-[10px] font-black uppercase tracking-[0.28em] border border-accent/20"><MapPin size={14} /> South Wales</div>
              ...
              <div className="space-y-5">
                <h1 className="text-4xl md:text-6xl font-black text-primary uppercase tracking-tighter leading-[0.95]">
                  Man and Van <span className="text-accent">Swansea</span>
                </h1>
            ...
            <div className="bg-white rounded-[2rem] border border-border p-6 lg:p-8 space-y-5 shadow-sm">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-xl font-black uppercase tracking-tight text-primary">Swansea moving challenges</h3>
                  <p className="text-sm text-text-secondary font-medium leading-relaxed mt-2">Swansea moves involve steep hills around Uplands and Brynmill, coastal properties near Mumbles with limited parking, M4 corridor traffic for cross-Wales moves, and student areas around Swansea University\u2019s Singleton and Bay campuses. The form captures these details so your mover can plan properly.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 space-y-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
            <div className="bg-primary rounded-[2rem] p-8 lg:p-10 min-h-[260px] flex flex-col justify-center space-y-5 shadow-sm">
              <h2 className="text-3xl md:text-4xl font-black uppercase tracking-tight text-white leading-tight">Coastal properties, <span className="text-accent">M4</span> corridor and student areas</h2>
              <p className="text-white/85 font-medium leading-relaxed text-base lg:text-lg">A move from a Brynmill terrace is different to a Sketty family home, a Mumbles coastal flat or a Gorseinon suburban house. The form asks for the details a mover needs: postcodes, items, helpers, stairs, lifts, access and date.</p>
            </div>
      ...
      <section className="py-16 bg-[#F9F9F7] border-y border-border">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-primary uppercase tracking-tight mt-4">Moving Services in Swansea</h2>
          </div>
      ...
      {/* Wales Areas */}
      {swanseaAreas.length > 0 && (
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 max-w-5xl">
            <div className="text-center mb-10">
              <span className="inline-block bg-accent/10 text-accent px-4 py-1.5 rounded-full text-[9px] font-black uppercase tracking-[0.35em]">Wales</span>
              <h2 className="text-3xl md:text-4xl font-black text-primary uppercase tracking-tight mt-4">Man and Van in Wales</h2>
              <p className="text-text-secondary mt-3 text-sm max-w-xl mx-auto">Swansea is our South West Wales hub. We also cover Cardiff and the M4 corridor — with more areas coming soon.</p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {swanseaAreas.map((area) => (
      ...
      <section className="py-16 bg-[#F9F9F7] border-y border-border">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-primary uppercase tracking-tight mt-4">Man and Van Prices in Swansea (2026)</h2>
          </div>
            ...
            <table className="w-full border-collapse">
              ...
              <tbody className="divide-y divide-border">
                {[
                  ...
                  { type: "Swansea to Cardiff", price: "£80–£180" },
                ].map((row, i) => (
      ...
      <section className="py-16 lg:py-24">
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="text-center mb-10 space-y-3">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-primary uppercase tracking-tight">Swansea man and van questions</h2>
          </div>
          <FAQ items={faqItems} />
        </div>
      </section>
      ...
      <section className="py-16 bg-[#F9F9F7] border-t border-border text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-black text-primary uppercase tracking-tighter mb-4">Ready to Move in Swansea?</h2>
