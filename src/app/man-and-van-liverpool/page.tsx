...
export const metadata: Metadata = {
  ...
  description:
    "Man with a van across Merseyside from £19/hr. From Liverpool city centre to Bootle, Birkenhead and Southport, one verified mover reviews your details before you book. Rated 5.0/5 from 5 reviews.",
  alternates: {
    canonical: `${baseUrl}/man-and-van-liverpool`,
  },
  openGraph: {
    title: "Man and Van Liverpool From £19/hr | Free Quotes",
    description: "Man with a van across Merseyside from £19/hr. From Liverpool city centre to Bootle, Birkenhead and Southport, one verified mover reviews your details before you book. Rated 5.0/5 from 5 reviews.",
  ...
  twitter: {
    ...
    title: "Man and Van Liverpool From £19/hr | Free Quotes",
    description: "Man with a van across Merseyside from £19/hr. One verified mover reviews your details before you book. Rated 5.0/5 from 5 reviews.",
