...
export const metadata: Metadata = {
  title: "Man and Van Cardiff | Verified Mover Quotes from £45",
  description: "Submit a free man and van request in Cardiff. One verified mover reviews your details before you book. From £45/hr.",
  alternates: { canonical: `${baseUrl}/man-and-van-cardiff` },
  openGraph: {
    title: "Man and Van Cardiff | Verified Mover Quotes from £45",
    description: "Submit a free man and van request in Cardiff. One verified mover reviews your details before you book. From £45/hr.",
    url: `${baseUrl}/man-and-van-cardiff`,
    images: [{ url: `${baseUrl}/api/og?title=${encodeURIComponent("Man and Van Cardiff")}&subtitle=${encodeURIComponent("Verified Mover Quotes from £45")}`, width: 1200, height: 630, alt: "Man and Van Cardiff | Verified Mover Quotes from £45" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Man and Van Cardiff | Verified Mover Quotes from £45",
    description: "Submit a free man and van request in Cardiff. One verified mover reviews your details before you book. From £45/hr.",
    images: [`${baseUrl}/api/og?title=${encodeURIComponent("Man and Van Cardiff")}&subtitle=${encodeURIComponent("Verified Mover Quotes from £45")}`],
  },
};

const faqItems = [
  { q: "How much does a man and van cost in Cardiff?", a: "Cardiff moves typically start from £45 per hour. The final quote depends on the postcodes, distance, item list, helpers required, stairs, parking and access. You can see a guide price first, then a verified mover reviews the details and sends a quote before you decide whether to book." },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="space-y-8">
              ...
              <div className="space-y-5">
                ...
                <p className="text-lg md:text-xl text-text-secondary font-medium leading-relaxed max-w-xl">Submit a free Cardiff move request, see a guide price and let one verified mover review your details before you decide whether to book. From £45/hr.</p>
              </div>
