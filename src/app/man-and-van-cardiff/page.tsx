...
export const metadata: Metadata = {
  title: "Man and Van Cardiff | Verified Mover Quotes from £19",
  description: "Submit a free man and van request in Cardiff. One verified mover reviews your details before you book. From £19/hr.",
  alternates: { canonical: `${baseUrl}/man-and-van-cardiff` },
  openGraph: {
    title: "Man and Van Cardiff | Verified Mover Quotes from £19",
    description: "Submit a free man and van request in Cardiff. One verified mover reviews your details before you book. From £19/hr.",
    url: `${baseUrl}/man-and-van-cardiff`,
    images: [{ url: `${baseUrl}/api/og?title=${encodeURIComponent("Man and Van Cardiff")}&subtitle=${encodeURIComponent("Verified Mover Quotes from £19")}`, width: 1200, height: 630, alt: "Man and Van Cardiff | Verified Mover Quotes from £19" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Man and Van Cardiff | Verified Mover Quotes from £19",
    description: "Submit a free man and van request in Cardiff. One verified mover reviews your details before you book. From £19/hr.",
    images: [`${baseUrl}/api/og?title=${encodeURIComponent("Man and Van Cardiff")}&subtitle=${encodeURIComponent("Verified Mover Quotes from £19")}`],
  },
};
