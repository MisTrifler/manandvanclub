...
export const metadata: Metadata = {
  title: "Man and Van Glasgow | Verified Mover Quotes from £34",
  description: "Submit a free man and van request in Glasgow. One verified mover reviews your details before you book. From £34/hr. West End, Shawlands, Dennistoun, Partick.",
  alternates: { canonical: `${baseUrl}/man-and-van-glasgow` },
  openGraph: {
    title: "Man and Van Glasgow | Verified Mover Quotes from £34",
    description: "Submit a free man and van request in Glasgow. One verified mover reviews your details before you book. From £34/hr.",
    url: `${baseUrl}/man-and-van-glasgow`,
    images: [{ url: `${baseUrl}/api/og?title=${encodeURIComponent("Man and Van Glasgow")}&subtitle=${encodeURIComponent("Verified Mover Quotes from £34")}`, width: 1200, height: 630, alt: "Man and Van Glasgow | Verified Mover Quotes from £34" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Man and Van Glasgow | Verified Mover Quotes from £34",
    description: "Submit a free man and van request in Glasgow. One verified mover reviews your details before you book. From £34/hr.",
    images: [`${baseUrl}/api/og?title=${encodeURIComponent("Man and Van Glasgow")}&subtitle=${encodeURIComponent("Verified Mover Quotes from £34")}`],
  },
};

const glasgowAreaCandidates = [
  { slug: "glasgow", name: "Glasgow", note: "Tenement closes, West End flats and city-centre moves" },
  { slug: "edinburgh", name: "Edinburgh", note: "Old Town closes, New Town flats and student moves" },
  { slug: "dundee", name: "Dundee", note: "City-centre flats, student moves and local collections" },
  { slug: "aberdeen", name: "Aberdeen", note: "Granite tenements, oil-industry relocations and family homes" },
];

const glasgowAreas = glasgowAreaCandidates
...
const faqItems = [
  { q: "How much does a man and van cost in Glasgow?", a: "Glasgow moves typically start from £34 per hour. A straightforward local move usually costs £60–£130 depending on furniture volume, access (stairs, lifts, parking) and M8 traffic. A full 3-bed house move in Glasgow could be £250–£500. Submit your postcodes and item list for a guide price first, then a verified mover reviews the details and sends a quote." },
  ...
  { q: "Can I book a same-day man and van in Glasgow?", a: "Same-day moves may be possible depending on mover availability, route and access. Glasgow\u2019s M8 corridor, the Clydeside Expressway and the A77 are factored into route planning. Submit the request with the correct postcodes and move details so a verified mover can review it quickly." },
  { q: "Can I use this for single-item furniture collection?", a: "Yes. The Glasgow service can be used for single items, furniture collection, student moves, flat moves, house removals, office moves and local storage runs." },
  { q: "Do you cover West End, Shawlands and Dennistoun?", a: "Yes. You can submit move requests for West End, Shawlands, Dennistoun, Partick, Hyndland, Pollokshields, Finnieston and surrounding areas. A verified mover will review your request and can quote if they work in those areas." },
  { q: "Can you help with student moves in Glasgow?", a: "Yes. Student moves can be submitted for areas near the West End, Partick and Dennistoun, close to Glasgow University and Strathclyde. Peak demand is June, July and September. Add your item list, access notes and preferred dates for a verified mover to review." },
  { q: "How much does a man and van cost from Glasgow to Edinburgh?", a: "A Glasgow to Edinburgh move in 2026 typically costs £80–£180 depending on load, access and timing. The M8 connects both cities in around 50 minutes. A single-item collection might start from £34–£80. Submit your postcodes and item list for a guide price." },
];

const serviceSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Man and Van Glasgow quote request",
  url: `${baseUrl}/man-and-van-glasgow`,
  provider: {
    "@type": "Organization",
  ...
  areaServed: {
    ...
    containsPlace: [
      ...
      { "@type": "Neighborhood", name: "Hyndland" },
      { "@type": "Neighborhood", name: "Pollokshields" },
      { "@type": "Neighborhood", name: "Finnieston" },
  ...
  description:
    "Free Glasgow man and van request service. Customers can see a guide price, submit details securely and receive a quote from one verified mover before booking.",
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Man and Van Glasgow", item: `${baseUrl}/man-and-van-glasgow` },
  ],
};

const services = [
  { icon: <Truck size={24} />, title: "House Removals", desc: "Family homes, tenement flats and suburban relocations across Glasgow.", href: "/house-removals" },
  { icon: <Building2 size={24} />, title: "Flat Moves", desc: "Tenement close moves, West End apartments and riverside flats.", href: "/flat-removals" },
  { icon: <GraduationCap size={24} />, title: "Student Moves", desc: "Glasgow Uni, Strathclyde and GSA student moves, June to September.", href: "/student-removals" },
  { icon: <Sofa size={24} />, title: "Furniture Delivery", desc: "Single-item collections, IKEA runs and marketplace pickups.", href: "/furniture-delivery" },
    ...
    <main className="bg-white min-h-screen selection:bg-accent selection:text-white">
        ...
        <div className="container mx-auto px-4 py-3">
          <ol className="flex items-center gap-2 text-xs font-medium text-primary/50">
            ...
            <li className="flex items-center gap-2">
              ...
              <span className="text-primary font-bold">Man and Van Glasgow</span>
            </li>
          </ol>
        </div>
      </nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="space-y-8">
              ...
              <div className="space-y-5">
                <h1 className="text-5xl md:text-7xl font-black text-primary uppercase tracking-tighter leading-[0.9]">Man and Van <span className="text-accent italic">Glasgow</span></h1>
                <p className="text-lg md:text-xl text-text-secondary font-medium leading-relaxed max-w-xl">Submit a free Glasgow move request, see a guide price and let one verified mover review your details before you decide whether to book. From £34/hr.</p>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div className="bg-white rounded-2xl border border-border p-5 text-center"><Package size={22} className="text-accent mx-auto mb-2" /><span className="text-[9px] font-black uppercase tracking-widest text-primary/50 block">From</span><span className="text-2xl font-black text-primary">£34<span className="text-sm font-bold text-text-secondary">/hr</span></span></div>
            ...
            <div className="bg-white rounded-[2rem] border border-border p-6 lg:p-8 space-y-5 shadow-sm">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-xl font-black uppercase tracking-tight text-primary">Glasgow moving challenges</h3>
                  <p className="text-sm text-text-secondary font-medium leading-relaxed mt-2">Glasgow moves involve tenement closes with narrow stone staircases, West End permit parking, the M8 corridor through the city centre, and student areas around Glasgow University and Strathclyde. Red sandstone tenements in Shawlands, Dennistoun and Partick often have upper-floor flats with no lift. The form captures these details so your mover can plan properly.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 space-y-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
            <div className="bg-primary rounded-[2rem] p-8 lg:p-10 min-h-[260px] flex flex-col justify-center space-y-5 shadow-sm">
              <h2 className="text-3xl md:text-4xl font-black uppercase tracking-tight text-white leading-tight">Tenement closes, <span className="text-accent">West End</span> parking and M8 timing</h2>
              <p className="text-white/85 font-medium leading-relaxed text-base lg:text-lg">A move from a Hyndland tenement is different to a Finnieston apartment, a Shawlands family home or a Paisley suburban house. The form asks for the details a mover needs: postcodes, items, helpers, stairs, lifts, access and date.</p>
            </div>
      ...
      <section className="py-16 bg-[#F9F9F7] border-y border-border">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-primary uppercase tracking-tight mt-4">Moving Services in Glasgow</h2>
          </div>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 max-w-5xl">
            <div className="text-center mb-10">
              ...
              <p className="text-text-secondary mt-3 text-sm max-w-xl mx-auto">Glasgow is our Scotland hub. We also cover Edinburgh, Dundee and Aberdeen — with more areas coming soon.</p>
            </div>
      ...
      <section className="py-16 bg-[#F9F9F7] border-y border-border">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-primary uppercase tracking-tight mt-4">Man and Van Prices in Glasgow (2026)</h2>
          </div>
            ...
            <table className="w-full border-collapse">
              ...
              <tbody className="divide-y divide-border">
                {[
                  ...
                  { type: "Glasgow to Edinburgh", price: "£80–£180" },
                ].map((row, i) => (
      ...
      <section className="py-16 lg:py-24">
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="text-center mb-10 space-y-3">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-primary uppercase tracking-tight">Glasgow man and van questions</h2>
          </div>
          <FAQ items={faqItems} />
        </div>
      </section>
      ...
      <section className="py-16 bg-[#F9F9F7] border-t border-border text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-black text-primary uppercase tracking-tighter mb-4">Ready to Move in Glasgow?</h2>
