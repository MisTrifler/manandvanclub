...
export const metadata: Metadata = {
  ...
  description: "Man with a van in York from £19/hr. One verified mover reviews your details before you book. Rated 5.0/5 from 5 reviews. City centre, Acomb, Haxby, Fulford.",
  alternates: { canonical: `${baseUrl}/man-and-van-york` },
  openGraph: {
    title: "Man and Van York From £19/hr | Free Quotes",
    description: "Man with a van in York from £19/hr. One verified mover reviews your details before you book. Rated 5.0/5 from 5 reviews.",
...
const faqItems = [
  { q: "How much does a man and van cost in York?", a: "York moves typically start from £19 per hour. A straightforward local move usually costs £60–£130 depending on furniture volume, access (stairs, lifts, parking) and A64 traffic. A full 3-bed house move in York could be £250–£500. Submit your postcodes and item list for a guide price first, then a verified mover reviews the details and sends a quote." },
  ...
  { q: "How much does a man and van cost from York to Leeds?", a: "A York to Leeds move in 2026 typically costs £80–£180 depending on load, access and timing. The A64 and A1(M) connect both cities in around 30–40 minutes. A single-item collection might start from £19–£80. Submit your postcodes and item list for a guide price." },
];
