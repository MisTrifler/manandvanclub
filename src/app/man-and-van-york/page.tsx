...
export const metadata: Metadata = {
  title: "Man and Van York | Verified Mover Quotes from £34",
  description: "Submit a free man and van request in York. One verified mover reviews your details before you book. From £34/hr. City centre, Acomb, Haxby, Fulford.",
  alternates: { canonical: `${baseUrl}/man-and-van-york` },
  openGraph: {
    title: "Man and Van York | Verified Mover Quotes from £34",
    description: "Submit a free man and van request in York. One verified mover reviews your details before you book. From £34/hr.",
    url: `${baseUrl}/man-and-van-york`,
    images: [{ url: `${baseUrl}/api/og?title=${encodeURIComponent("Man and Van York")}&subtitle=${encodeURIComponent("Verified Mover Quotes from £34")}`, width: 1200, height: 630, alt: "Man and Van York | Verified Mover Quotes from £34" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Man and Van York | Verified Mover Quotes from £34",
    description: "Submit a free man and van request in York. One verified mover reviews your details before you book. From £34/hr.",
    images: [`${baseUrl}/api/og?title=${encodeURIComponent("Man and Van York")}&subtitle=${encodeURIComponent("Verified Mover Quotes from £34")}`],
  },
};

const yorkAreaCandidates = [
  { slug: "york", name: "York", note: "Historic city moves, narrow streets and student relocations" },
  { slug: "hull", name: "Hull", note: "East Yorkshire hub, A1079 corridor and student moves" },
...
const yorkAreas = yorkAreaCandidates
...
const faqItems = [
  { q: "How much does a man and van cost in York?", a: "York moves typically start from £34 per hour. A straightforward local move usually costs £60–£130 depending on furniture volume, access (stairs, lifts, parking) and A64 traffic. A full 3-bed house move in York could be £250–£500. Submit your postcodes and item list for a guide price first, then a verified mover reviews the details and sends a quote." },
  ...
  { q: "How much does a man and van cost from York to Leeds?", a: "A York to Leeds move in 2026 typically costs £80–£180 depending on load, access and timing. The A64 and A1(M) connect both cities in around 30–40 minutes. A single-item collection might start from £34–£80. Submit your postcodes and item list for a guide price." },
];

const serviceSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Man and Van York quote request",
  url: `${baseUrl}/man-and-van-york`,
  provider: {
    "@type": "Organization",
  ...
  areaServed: {
    ...
    containsPlace: [
      ...
      { "@type": "Neighborhood", name: "Osbaldwick" },
  ...
  description:
    "Free York man and van request service. Customers can see a guide price, submit details securely and receive a quote from one verified mover before booking.",
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Man and Van York", item: `${baseUrl}/man-and-van-york` },
  ],
};
    ...
    <main className="bg-white min-h-screen selection:bg-accent selection:text-white">
        ...
        <div className="container mx-auto px-4 py-3">
          <ol className="flex items-center gap-2 text-xs font-medium text-primary/50">
            ...
            <li className="flex items-center gap-2">
              ...
              <span className="text-primary font-bold">Man and Van York</span>
            </li>
          </ol>
        </div>
      </nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="space-y-8">
              <div className="flex flex-wrap items-center gap-3">
                <div className="inline-flex items-center gap-2 bg-accent/10 text-accent px-4 py-2 rounded-full text-[10px] font-black uppercase tracking-[0.28em] border border-accent/20"><MapPin size={14} /> North Yorkshire</div>
              ...
              <div className="space-y-5">
                <h1 className="text-4xl md:text-6xl font-black text-primary uppercase tracking-tighter leading-[0.95]">
                  Man and Van <span className="text-accent">York</span>
                </h1>
            ...
            <div className="bg-white rounded-[2rem] border border-border p-6 lg:p-8 space-y-5 shadow-sm">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-xl font-black uppercase tracking-tight text-primary">York moving challenges</h3>
                  <p className="text-sm text-text-secondary font-medium leading-relaxed mt-2">York moves involve narrow medieval streets within the city walls, restricted parking zones near the Minster, A64 corridor traffic, and student areas around Heslington and the University of York. Georgian terraces in Fulford and period properties in Acomb often need careful handling. The form captures these details so your mover can plan properly.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 space-y-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
            <div className="bg-primary rounded-[2rem] p-8 lg:p-10 min-h-[260px] flex flex-col justify-center space-y-5 shadow-sm">
              <h2 className="text-3xl md:text-4xl font-black uppercase tracking-tight text-white leading-tight">Medieval streets, <span className="text-accent">Georgian</span> terraces and A64 timing</h2>
              <p className="text-white/85 font-medium leading-relaxed text-base lg:text-lg">A move from a Fulford period terrace is different to a Haxby family home, a Heslington student flat or a Bishopthorpe suburban house. The form asks for the details a mover needs: postcodes, items, helpers, stairs, lifts, access and date.</p>
            </div>
      ...
      <section className="py-16 bg-[#F9F9F7] border-y border-border">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-primary uppercase tracking-tight mt-4">Moving Services in York</h2>
          </div>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 max-w-5xl">
            <div className="text-center mb-10">
              ...
              <p className="text-text-secondary mt-3 text-sm max-w-xl mx-auto">York is our North Yorkshire hub. We also cover Hull, Leeds and Sheffield — with more areas coming soon.</p>
            </div>
      ...
      <section className="py-16 bg-[#F9F9F7] border-y border-border">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-primary uppercase tracking-tight mt-4">Man and Van Prices in York (2026)</h2>
          </div>
            ...
            <table className="w-full border-collapse">
              ...
              <tbody className="divide-y divide-border">
                {[
                  ...
                  { type: "York to Leeds", price: "£80–£180" },
                ].map((row, i) => (
      ...
      <section className="py-16 lg:py-24">
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="text-center mb-10 space-y-3">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-primary uppercase tracking-tight">York man and van questions</h2>
          </div>
          <FAQ items={faqItems} />
        </div>
      </section>
      ...
      <section className="py-16 bg-[#F9F9F7] border-t border-border text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-black text-primary uppercase tracking-tighter mb-4">Ready to Move in York?</h2>
