...
export const metadata: Metadata = {
  ...
  description: "Man with a van in York from £19/hr. One verified mover reviews your details before you book. Rated 5.0/5 from 6 reviews. City centre, Acomb, Haxby, Fulford.",
  alternates: { canonical: `${baseUrl}/man-and-van-york` },
  openGraph: {
    title: "Man and Van York From £19/hr | Free Quotes",
    description: "Man with a van in York from £19/hr. One verified mover reviews your details before you book. Rated 5.0/5 from 6 reviews.",
