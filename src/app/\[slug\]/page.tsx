...
const pageContent: Record<string, any> = {
  "london": {
    ...
    intro: "London is the UK's busiest moving market. From high-rises in Canary Wharf to Victorian terraces in Hackney, our London movers handle the capital's unique challenges daily.",
  ...
  "birmingham": {
    ...
    intro: "As the UK's second city, Birmingham has diverse moving needs. Our network covers everything from large house removals in Solihull to student moves near UoB.",
    knowledge: "Our movers account for local traffic patterns around the Bullring and major transport routes like the M6 and A38, ensuring punctual collections and deliveries.",
  ...
  "manchester": {
    ...
    intro: "Manchester is a hub of relocation. From modern apartment blocks in Ancoats to residential streets in Didsbury, our movers offer flexible, professional services.",
  ...
  "leeds": {
    name: "Leeds",
    title: "Man and Van Leeds | Expert Yorkshire Movers | Man and Van Club",
    description: "Vetted man and van in Leeds. Professional moving services for Headingley, Roundhay & city centre. Fully insured house removals across West Yorkshire.",
    badge: "West Yorkshire Network",
    intro: "Leeds is the heart of West Yorkshire moving. From student relocations in Headingley to family home moves in Roundhay, our Leeds movers provide local expertise.",
    knowledge: "We understand the unique geography of Leeds, from the busy inner ring road to the steep streets of the suburbs. Our movers ensure your items are secured and delivered safely.",
    areas: ["Headingley", "Roundhay", "Chapel Allerton", "Horsforth", "Alwoodley", "Morley", "Pudsey", "City Centre"],
    faq: [
      { q: "What is the cost of a man and van in Leeds?", a: "Local Leeds moves start from £45. A full house relocation in West Yorkshire typically averages between £300 and £650." },
      { q: "Do you handle student moves for Leeds Uni?", a: "Yes, we have a specialized team for student moves in Headingley and Hyde Park." }
    ]
  },
  "bristol": {
    name: "Bristol",
    title: "Man and Van Bristol | Secure Local Removals | Man and Van Club",
    description: "Top-rated man and van in Bristol. Secure movers for Clifton, Bedminster & Redland. Expert furniture collection and house moves across the South West.",
    badge: "South West Moving Pros",
    intro: "Bristol's unique character requires local moving knowledge. Our vetted movers are experts at navigating Clifton's narrow hills and Bedminster's busy streets.",
    knowledge: "We account for Bristol's clean air zone and parking restrictions, ensuring a compliant and efficient moving process for both residential and commercial clients.",
    areas: ["Clifton", "Bedminster", "Redland", "St George", "Bishopston", "Fishponds", "Horfield", "City Centre"],
    faq: [
      { q: "How much is a man and van in Bristol?", a: "Small local collections start from £50. Larger house moves in Bristol typically range from £250 to £700." },
      { q: "Do you cover the Bristol Clean Air Zone?", a: "Yes, all our Bristol-based movers use vehicles that are compliant with local environmental regulations." }
    ]
  },
  "nottingham": {
    name: "Nottingham",
    ...
    intro: "From the busy student areas of Lenton to the family homes of West Bridgford, our Nottingham movers provide tailored services for every type of relocation.",
  ...
  "edinburgh": {
    name: "Edinburgh",
    title: "Man and Van Edinburgh | Trusted Scottish Movers | Man and Van Club",
    description: "Expert man and van in Edinburgh. Vetted movers for Leith, Morningside & city centre. Specialist apartment movers for narrow New Town streets.",
    badge: "Edinburgh Moving Pros",
    intro: "Edinburgh's historic architecture presents unique moving challenges. Our local movers are experts at navigating narrow New Town stairs and cobbled Leith streets.",
    knowledge: "We know Edinburgh's parking permits and festival season restrictions inside out, ensuring your move is handled with precision and local insight.",
    areas: ["Leith", "Morningside", "Stockbridge", "New Town", "Old Town", "Portobello", "Corstorphine", "Marchmont"],
    faq: [
      { q: "Is moving in Edinburgh more expensive?", a: "Prices are competitive with other major UK cities, starting from £60. Narrow access in the Old Town may require specific vehicle sizes which we provide." },
      { q: "Do you cover the Lothians?", a: "Yes, our Edinburgh network extends to East, West, and Midlothian areas." }
    ]
  },
  "wolverhampton": {
    name: "Wolverhampton",
    ...
    intro: "Our Wolverhampton movers are deeply rooted in the Black Country. Whether you're moving near Molineux or out to the suburbs of Tettenhall, we've got you covered.",
  ...
  "walsall": {
    ...
    intro: "Providing reliable moving services across Walsall and the surrounding boroughs. We handle everything from small furniture pickups to full house relocations.",
  ...
  "house-removals": {
    name: "House Removals",
    title: "House Removals UK | Vetted Local Movers | Man and Van Club",
  ...
  "flat-removals": {
    name: "Flat Removals",
    title: "Flat Removals UK | Apartment Movers | Man and Van Club",
...
const defaultPage = (slug: string) => {
  ...
  return {
    ...
    description: `Professional ${name} services near you. Get exclusively matched with a vetted local mover for a stress-free experience. UK-wide coverage.`,
    badge: name,
...
export async function generateStaticParams() {
  const cities = ["london", "birmingham", "manchester", "leeds", "bristol", "liverpool", "nottingham", "sheffield", "glasgow", "cardiff", "walsall", "edinburgh", "wolverhampton"].map(c => `man-and-van-${c}`);
