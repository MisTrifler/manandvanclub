...
export const metadata: Metadata = {
  ...
  description:
    "Man with a van across West Yorkshire from £19/hr. From Leeds city centre to Bradford, Huddersfield and Halifax, one verified mover reviews your details before you book. Rated 5.0/5 from 6 reviews.",
  alternates: {
    canonical: `${baseUrl}/man-and-van-leeds`,
  },
  openGraph: {
    title: "Man and Van Leeds From £19/hr | Free Quotes",
    description: "Man with a van across West Yorkshire from £19/hr. From Leeds city centre to Bradford, Huddersfield and Halifax, one verified mover reviews your details before you book. Rated 5.0/5 from 6 reviews.",
  ...
  twitter: {
    ...
    title: "Man and Van Leeds From £19/hr | Free Quotes",
    description: "Man with a van across West Yorkshire from £19/hr. One verified mover reviews your details before you book. Rated 5.0/5 from 6 reviews.",
