...
export const metadata: Metadata = {
  title: "Man and Van Leeds | Verified Mover Quotes from £50",
  description:
  ...
  openGraph: {
    ...
    images: [{ url: "/images/og-homepage.jpg", width: 1200, height: 630, alt: "Man and Van Leeds | Verified Mover Quotes" }],
  },
  twitter: {
...
const faqItems = [
  {
    ...
    a: "Leeds moves typically start from £50 per hour. The final quote depends on the postcodes, distance, item list, helpers required, stairs, parking and access. You can see a guide price first, then a verified mover reviews the details and sends a quote before you decide whether to book.",
  },
  {
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-5">
                ...
                <p className="text-lg md:text-xl text-text-secondary font-medium leading-relaxed max-w-xl">
                  Submit a free West Yorkshire move request, see a guide price and let one verified mover review your details before you decide whether to book. From £50/hr.
                </p>
              </div>
