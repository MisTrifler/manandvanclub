...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const locationLastModified: Record<string, string> = {
    ...
    'lisburn': '2026-07-15',
    'newry': '2026-07-15',
    'sunderland': '2026-07-15',
    'middlesbrough': '2026-07-15',
    'gateshead': '2026-07-15',
    'darlington': '2026-07-15',
    'durham': '2026-07-15',
    'hartlepool': '2026-07-15',
    'doncaster': '2026-07-15',
    'rotherham': '2026-07-15',
    'barnsley': '2026-07-15',
    'brighton': '2026-07-15',
    'milton-keynes': '2026-07-15',
    'luton': '2026-07-15',
    'bournemouth': '2026-07-15',
    'slough': '2026-07-15',
    'medway': '2026-07-15',
    'crawley': '2026-07-15',
    'maidstone': '2026-07-15',
    'horsham': '2026-07-15',
    'peterborough': '2026-07-15',
    'norwich': '2026-07-15',
    'ipswich': '2026-07-15',
    'colchester': '2026-07-15',
    'basildon': '2026-07-15',
    'exeter': '2026-07-15',
    'torquay': '2026-07-15',
    'truro': '2026-07-15',
    ...
    'wrexham': '2026-07-15',
    'bangor': '2026-07-15',
    'aberystwyth': '2026-07-15',
    'inverness': '2026-07-15',
    'stirling': '2026-07-15',
    'perth': '2026-07-15',
    'paisley': '2026-07-15',
    'east-kilbride': '2026-07-15',
    'livingston': '2026-07-15',
    'falkirk': '2026-07-15',
  };
  ...
  const staticUrls = [
    ...
    { route: '/man-and-van-hull', priority: 0.95, freq: 'weekly' as const },
    { route: '/man-and-van-york', priority: 0.95, freq: 'weekly' as const },
    ...
    { route: '/man-and-van-belfast', priority: 0.95, freq: 'weekly' as const },
    { route: '/man-and-van-brighton', priority: 0.95, freq: 'weekly' as const },
    { route: '/man-and-van-sunderland', priority: 0.95, freq: 'weekly' as const },
    { route: '/man-and-van-milton-keynes', priority: 0.95, freq: 'weekly' as const },
    { route: '/man-and-van-bournemouth', priority: 0.95, freq: 'weekly' as const },
