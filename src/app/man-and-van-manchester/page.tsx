...
export const metadata: Metadata = {
  ...
  description:
    "Man with a van across Greater Manchester from £19/hr. From the city centre to Stockport and Bolton, one verified mover reviews your details before you book. Rated 5.0/5 from 5 reviews.",
  alternates: {
    canonical: `${baseUrl}/man-and-van-manchester`,
  },
  openGraph: {
    title: "Man and Van Manchester From £19/hr | Free Quotes",
    description: "Man with a van across Greater Manchester from £19/hr. From the city centre to Stockport and Bolton, one verified mover reviews your details before you book. Rated 5.0/5 from 5 reviews.",
  ...
  twitter: {
    ...
    title: "Man and Van Manchester From £19/hr | Free Quotes",
    description: "Man with a van across Greater Manchester from £19/hr. One verified mover reviews your details before you book. Rated 5.0/5 from 5 reviews.",
